import { MessageCircle, Mail, Scale, Phone } from "lucide-react";
      ...
      <div
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p
            ...
            Uma conversa sem compromisso para entender os desafios jurídicos
            da sua organização e descobrir como posso ajudar.
          </p>
      ...
      <div className="py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <p
              className="text-xs"
              style={{ color: "hsl(var(--ivory) / 0.5)" }}>André Andrade da Silva - OAB/SP 489.013 - Advogado especializado em Terceiro Setor
